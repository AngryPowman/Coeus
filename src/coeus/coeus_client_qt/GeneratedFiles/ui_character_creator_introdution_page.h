...
public:
    ...
    void setupUi(QWizardPage *CharacterCreator_IntrodutionPage)
    {
        ...
        label->setGeometry(QRect(174, 54, 412, 70));
        QFont font;
        font.setPointSize(9);
    ...
    void retranslateUi(QWizardPage *CharacterCreator_IntrodutionPage)
    {
        ...
        CharacterCreator_IntrodutionPage->setTitle(QApplication::translate("CharacterCreator_IntrodutionPage", "\345\210\233\345\273\272\350\247\222\350\211\262", 0));
